  ...
  return (
    ...
    >
      <Html>
        ...
        <Preview>Welcome to the MatchChayn newsletter! 🎉</Preview>
        <Body className="bg-[#09090b] font-sans m-0 px-2 py-4">
          <Container className="bg-[#18181b] mx-auto rounded-2xl shadow-lg overflow-hidden max-w-[600px] border border-solid border-[#27272a]">
            ...
            {/* Hero Image */}
            <Section className="w-full bg-[#09090b] pt-2 pb-6 flex justify-center text-center border-y border-solid border-[#27272a]">
              <Img
            ...
            <Section className="px-10 py-10">
              <Heading className="text-[#7c3aed] text-3xl font-serif p-0 m-0 mb-6 leading-tight">
                Welcome to MatchChayn! 💜🎉
              </Heading>
              <Text className="text-white text-base leading-7 m-0 mb-4">
                We'll keep you updated with all the latest news, updates, and everything happening on MatchChayn.
              </Text>
              <Text className="text-white text-base leading-7 m-0 mb-4">
                Expect to hear from us about new feature drops, community events, and early access opportunities.
              </Text>
